...
taxonomy:
    category:
        - docs
menu: Register
media_order: 'How to register a Layershift helpdesk account.png,registration form for a new helpdesk account.png,Create a new helpdesk account.png,send registration form for a new helpdesk account.png,your ticket history.png'
metadata:
    description: 'Step by step instructions on how to create a new Layershift helpdesk account.'
    'og:url': 'https://www.layershift.com/kb/support/how-to-register-an-account'
    'og:type': website
    'og:title': 'How to register an account | Layershift KB'
    'og:description': 'Step by step instructions on how to create a new Layershift helpdesk account.'
    'og:image': 'https://www.layershift.com/kb/user/pages/08.support/01.how-to-register-an-account/How to register a Layershift helpdesk account.png'
...
aura:
    pagetype: website
    description: 'Step by step instructions on how to create a new Layershift helpdesk account.'
    image: 'How to register a Layershift helpdesk account.png'
    metadata:
        keywords: 'layershift support helpdesk tickets support cases'
---
