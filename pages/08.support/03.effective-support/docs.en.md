...
aura:
    pagetype: website
metadata:
    'og:url': 'https://www.layershift.com/kb/support/effective-support'
    'og:type': website
    'og:title': 'Effective support | Layershift KB'
    'og:image': 'https://www.layershift.com/kb/user/images/ls-kb.jpg'
    'og:image:type': image/jpeg
    'og:image:width': 1200
    'og:image:height': 630
    'og:author': Layershift
    'article:published_time': '2026-05-29T13:51:41+01:00'
    'article:modified_time': '2026-05-29T16:32:18+01:00'
    'article:author': Layershift
media_order: 'Effective support.png,priority escalations.png'
---
...
* Try to keep one issue per ticket
* Provide the server hostname or IP address
* Provide the full URL
* Provide a detailed description of the issue you are encountering, including any actions you've taken already (to cause, or try to fix the issue), and any error messages or log entries you've noticed
* Include step by step instructions (and any login details) required to reproduce the issue you're facing
* Don't resume old tickets which were already closed: instead, open a new ticket and reference the old ticket ID
...
![priority%20escalations](priority%20escalations.png "priority%20escalations")
